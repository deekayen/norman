...
wsconsctl keyboard.encoding=us  \
    ...
    keyboard.map+="keycode  18 =              d             D   dead_diaeresis        asciitilde " \
    ...
    keyboard.map+="keycode  49 =              p             P           oslash          Ooblique " \
    ...
    keyboard.map+="keycode  53 =          slash      question     questiondown        asciitilde " \
                                                                                                   \
    keyboard.map+="keycode  58 =      BackSpace     Caps_Lock        Caps_Lock         Caps_Lock " \
